...
public final class EmailService {
    ...
    public static void sendBiweeklyEmailWithAttachment(final String email_address, final String year_batch, final CachedData cachedData){
    ...
    public static void sendUrgentServiceEmail_V2(final String email_address, final String cachedUrgSerSpeEmailHTML){
        Dispatch mail = Dispatch
                .invoke(new ActiveXComponent("Outlook.Application"),
                        "CreateItem",
                        Dispatch.Get,
